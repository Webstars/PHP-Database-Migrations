...
final class Mig_Manager
{
    ...
    /**
     * Creates a migration containing all of the actions in previous migrations
     * Used to unclutter the migrations dir
     *
     * @return void
     */
    public static function merge()
    {
        $merger = new Mig_Merger(self::getMigrationStorage());
        $bodies = $merger->getMergedBodies();
        $filename = time() . '_all_merged';

        Mig_Migration_Factory::create($filename, $bodies);
        Mig_Printer::pr('Merged all migration files into: ' . $filename . '.php');
    }
}
